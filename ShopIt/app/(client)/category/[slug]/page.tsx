            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {relatedCategories.map((category) => (
                <Link
                  ...
                  className="group bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-gray-100 hover:border-shop_light_blue p-4 text-center"
                >
                  {/* Category Image */}
                  <div className="w-12 h-12 mx-auto mb-3 bg-gradient-to-br from-shop_light_pink to-shop_light_bg rounded-lg flex items-center justify-center">
                    {category.image ? (
                      ...
                      <Package className="w-6 h-6 text-shop_light_blue opacity-60" />
                    )}
                  </div>
